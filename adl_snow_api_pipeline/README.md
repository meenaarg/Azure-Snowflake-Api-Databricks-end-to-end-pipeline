...
The 'adl_snow_api_pipeline' project was generated by using the default-python template.

* `src/`: Python source code for this project.
  * `src/adl_snow_api_pipeline/`: Shared Python code that can be used by jobs and pipelines.
...
2. To deploy a development copy of this project, type:
    ...
    `[dev yourname] adl_snow_api_pipeline_etl` to your workspace.
